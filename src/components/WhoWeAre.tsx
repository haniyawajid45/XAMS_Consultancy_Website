    ...
    <section id="about-us" className="py-12 sm:py-16 lg:py-20 bg-white border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-6 relative">
          ...
          <div className="absolute top-0 left-0 w-24 h-24 bg-blue-600/5 rounded-full blur-2xl pointer-events-none" />
          <div className="bg-slate-950 text-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-xl border border-slate-800 relative overflow-hidden">
            ...
            <h3 className="text-base sm:text-lg font-sans font-extrabold uppercase tracking-wide text-blue-400 mb-4 sm:mb-6">
            ...
            <div className="mt-6 sm:mt-8 p-3 rounded-xl bg-blue-900/30 border border-blue-800/50 text-[10px] sm:text-[11px] leading-relaxed text-blue-200">
