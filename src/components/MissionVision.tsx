...
export default function MissionVision() {
  const missionBullets = [
    {
      ...
      icon: GraduationCap,
      color: "text-green-400 bg-green-950/60 border-green-800/60",
    },
    {
  ...
  return (
    <section id="where-we-come-from" className="relative py-12 sm:py-16 lg:py-20 bg-slate-900 overflow-hidden text-white">
      ...
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-green-500/10 rounded-full blur-3xl z-0 pointer-events-none" />
      <div className="absolute bottom-0 left-10 w-96 h-96 bg-green-500/10 rounded-full blur-3xl z-0 pointer-events-none" />

      <div className="relative z-10 max-w-7xl mx-auto px-4 space-y-8 sm:space-y-12">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto space-y-2.5 sm:space-y-3">
          <span className="text-[11px] sm:text-xs font-mono font-bold text-green-400 uppercase tracking-widest bg-green-950/80 border border-green-800/50 px-3 sm:px-3.5 py-1.5 rounded-full inline-block">
            Strategic Direction
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 relative flex flex-col justify-between rounded-2xl sm:rounded-3xl bg-slate-950 border border-slate-800 p-5 sm:p-8 lg:p-10 shadow-2xl group hover:border-green-600/50 transition-all duration-300">
            <div className="space-y-5 sm:space-y-6">
              <div className="flex items-center justify-between">
                <div className="inline-flex h-11 w-11 sm:h-14 sm:w-14 items-center justify-center rounded-xl sm:rounded-2xl bg-green-900/40 text-green-400 border border-green-700/50 shadow-md">
                  <Eye className="h-5 w-5 sm:h-7 sm:w-7" />
                </div>
                <span className="text-[9px] sm:text-[10px] font-mono font-bold uppercase tracking-widest bg-green-950/80 text-green-300 border border-green-800/60 px-2.5 py-1 rounded-full">
                  Target Horizon
                </span>
              </div>

              <div>
                <span className="block text-[11px] sm:text-xs uppercase font-mono tracking-widest text-green-400 font-semibold mb-1">
                  Our Vision
                </span>
              ...
              <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-gradient-to-br from-green-950/60 to-slate-900 border border-green-900/40 shadow-inner">
            ...
            <div className="mt-6 sm:mt-8 pt-3 sm:pt-4 flex items-center justify-between border-t border-slate-900 text-slate-500 text-[10px] sm:text-xs font-mono">
              ...
              <span className="text-green-400 font-bold">GLOBAL LEADERSHIP</span>
            </div>
          </div>

          {/* Mission Card (Second - 7 Columns) */}
          <div className="lg:col-span-7 relative flex flex-col justify-between rounded-2xl sm:rounded-3xl bg-slate-950 border border-slate-800 p-5 sm:p-8 lg:p-10 shadow-2xl group hover:border-green-600/50 transition-all duration-300">
            <div className="space-y-5 sm:space-y-6">
              <div className="flex items-center justify-between">
                <div className="inline-flex h-11 w-11 sm:h-14 sm:w-14 items-center justify-center rounded-xl sm:rounded-2xl bg-green-900/40 text-green-400 border border-green-700/50 shadow-md">
              ...
              <div className="space-y-2.5 sm:space-y-3">
                {missionBullets.map((bullet, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="flex items-start gap-3 p-3.5 sm:p-4 rounded-xl bg-slate-900/80 border border-slate-800/90 hover:border-green-800/50 transition-colors"
                    >
            ...
            <div className="mt-6 sm:mt-8 pt-3 sm:pt-4 flex items-center justify-between border-t border-slate-900 text-slate-500 text-[10px] sm:text-xs font-mono">
              ...
              <span className="text-green-400 font-bold">100% REGULATORY &amp; CAREER READY</span>
            </div>
          </div>
        </div>
      </div>
