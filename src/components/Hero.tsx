...
export default function Hero({ onOpenCounselling }: HeroProps) {
  return (
    <section className="relative overflow-hidden bg-slate-950 py-12 sm:py-16 lg:py-28 text-white">
      ...
      <div className="absolute top-0 right-0 w-1/3 h-full bg-green-600/10 blur-3xl rounded-full z-0 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-green-900/40 border border-green-700/50 rounded-full pl-2 pr-3.5 py-1 text-[11px] sm:text-xs text-green-300 font-mono tracking-wider sm:tracking-widest uppercase max-w-full truncate">
            <img src={logoImg} alt="XAMS Emblem" className="w-4 h-4 sm:w-5 sm:h-5 rounded-full border border-green-400 object-cover shrink-0" />
          ...
          <h1 id="hero-tagline" className="text-2xl sm:text-4xl lg:text-5xl font-sans font-extrabold text-white tracking-tight leading-[1.25]">
            Elite Career Guidance &amp; <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-300">ISO Standards</span> Consultancy
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-2 sm:pt-4">
            <button
              ...
              className="group flex items-center justify-center gap-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 active:scale-[0.98] text-white font-sans font-semibold px-5 sm:px-8 py-3.5 sm:py-4 rounded-xl shadow-lg shadow-green-900/35 transition-all cursor-pointer text-sm sm:text-base text-center"
            >
            ...
            <a
              ...
              className="flex items-center justify-center text-xs sm:text-sm font-semibold text-slate-200 hover:text-green-300 transition-colors py-3 sm:py-3.5 px-5 sm:px-6 border border-slate-700 rounded-xl bg-slate-900/40 hover:bg-slate-950/60 text-center"
            >
          ...
          <div className="pt-4 sm:pt-6 grid grid-cols-2 gap-3 sm:gap-4 border-t border-slate-800/80">
            <div>
              <span className="block text-lg sm:text-2xl font-extrabold text-green-400">100%</span>
              <span className="text-[11px] sm:text-xs text-slate-400 font-mono tracking-wider block">Confidential counselling</span>
            </div>
            <div>
              <span className="block text-lg sm:text-2xl font-extrabold text-green-400">Audit-Ready</span>
        ...
        >
          <div className="relative rounded-2xl bg-gradient-to-b from-slate-900/90 to-slate-950 border border-slate-800 p-5 sm:p-8 shadow-2xl backdrop-blur-md">
            ...
            <div className="space-y-3 sm:space-y-4">
              {[
                ...
                <div key={idx} className="flex gap-3 sm:gap-4 items-start">
                  <div className="flex h-7 w-7 sm:h-8 sm:w-8 shrink-0 items-center justify-center rounded-lg bg-green-900/50 text-green-400 text-xs font-mono font-bold mt-0.5">
                    {item.step}
                  </div>
                  <div>
            ...
            {/* Quick trust prompt */}
            <div className="mt-5 sm:mt-6 p-3 rounded-lg bg-green-950/40 border border-green-900/30 flex items-center gap-2.5 sm:gap-3">
